return {

	{
		...
		config = function()
			...
			local all_servers = {'ltex', 'pylsp', 'jedi_language_server', 'clangd', 'fortls', 'julials', 'superhtml', 'arduino_language_server', }
			require('mason-lspconfig').setup({ ensure_installed = all_servers, automatic_installation = true })

			local servers = {'clangd', 'fortls', 'julials', 'superhtml', 'arduino_language_server', }
			...
			require'lspconfig'.ltex.setup {
				...
				filetypes = { "markdown", "text", "tex", "plaintex", "rtf", "mail" },   -- added email file type for thunderbird
			}
